			...
			'fields'				=> array(
				...
				array(
					...
					'options'		=> [
					    ...
					    'draft'     => 'Draft (incomplete post viewable by anyone with proper user level)', 
					    'pending'   => 'Pending (awaiting a user with the publish_posts capability to publish)',
					    'private'   => 'Private (viewable only to WordPress users at Administrator level)',
					    'trash'     => 'Trash (why would you want this?)'
                    ],
					'default'		=> 'publish',
				),
			)
